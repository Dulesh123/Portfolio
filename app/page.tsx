...
// //       {/* Foreground content */}
// //       <div className="relative z-10 flex justify-center   items-start px-6 py-12 md:py-24 col-span-1">
// //         <div className="w-full md:w-1/3 grid grid-cols-1 gap-12 flex justify-between">
...
// //                 alt="my image"
// //                 className="rounded-3xl w-3/4 md:w-auto h-auto"
// //               />
// //             </div>

// //             {/* Social Icons */}
// //             <div className="grid grid-cols-1 md:justify-start gap-6 mx-50 mt-20">
// //               <a
// //                 className="hover:bg-gray-800 rounded-xl p-4 text-center  h-15 w-15 text-white col-span-1"
// //                 href="https://x.com/DShivakale?t=Fs_X7BkJB1fBoT4y9uS0oQ&s=09"
// //               >
// //                 <X />
// //               </a>
// //               <a
// //                 className="hover:bg-gray-800 rounded-xl p-4 w-15 text-center col-span-1 h-15 text-white"
// //                 href="mailto:duleshshivakale@gmail.com"
// //               >
// //                 <Insta />
// //               </a>
// //               <a
// //                 className="hover:bg-gray-800 rounded-xl w-15 p-4 text-center col-span-1 h-15 text-white"
...
// //             <div className="text-5xl text-white">Hi, I'm Dulesh</div>
// //             <div className="text-2xl text-gray-400 mt-5">
// //               21, Belagavi | Full Stack Engineer
// //             </div>
// //             <div className="text-xl text-gray-400 mt-4 leading-relaxed">
...
// //             <div className="text-blue-500 text-3xl font-semibold mb-3">
// //               Projects
// //             </div>
...
// //         </div>
// //       </div>
// //       <div className="-mt-10 w-screen h-screen md:py-24  flex justify-center">
// //         <div className=" w-1/3 h-screen -mt-25">
// //           {/* <div className="bg-gray-900 w-full h-1/4 rounded-3xl ">

// //         <div className="flex w-full h-full  ">
// //           <div className="bg-white col-span-1 h-full w-1/100 rounded-3xl"></div>
// //          <div className=" col-span-11 h-full w-99/100 bg-yellow-200 rounded-3xl"></div>
// //         </div>
...
// //               }}
// //               className="bg-gray-900 w-full h-1/4 rounded-xl overflow-hidden hover:bg-gray-800 mt-10"
// //             >
// //               <div className="flex w-full h-full">
// //                 {/* Left white strip */}
// //                 <div className="relative w-[1%] h-full rounded-l-3xl overflow-hidden absolute inset-0 bg-gradient-to-r from-transparent via-cyan-500 to-transparent opacity-10 animate-[pulse_4s_infinite]">
...
// //                     <div className="text-blue-500 text-xl -mx-8">
// //                       <Brain />
// //                       <span className="text-white"> Second-Brain</span>
// //                     </div>
...
// //                     </div>
// //                   </div>
// //                   <div className=" h-1/3 w-full text-white text-center text-xl -px-5 flex items-center">
// //                     <div className="mx-12 text-gray-400">
// //                       {" "}
// //                       A Link Mangement Web-App
// //                     </div>
// //                     <a
...
// //                     </a>
// //                   </div>
// //                   <div className=" h-1/3 w-full text-white text-center text-xl -px-5 flex justify-around items-center">
// //                     <button className="text-gray-400 h-8 w-1/6 rounded-xl bg-black hover:bg-gray-600  text-lg hover:text-white">
// //                       React
// //                     </button>
// //                     <button className="text-gray-400 h-8 w-1/6 rounded-xl bg-black hover:bg-gray-600 text-lg hover:text-white">
// //                       Nodejs
...
// //             // popupp
// //             <div
// //               className="w-1/3 h-1/3 rounded-3xl bg-gray-900 p-6 shadow-2xl bg-[radial-gradient(circle_at_top_left,_rgba(0,255,255,0.15),_transparent_60%),_radial-gradient(circle_at_bottom_right,_rgba(255,0,255,0.15),_transparent_60%)] transition-all duration-300 ease-out"
// //               onClick={() => {
// //                 setShowPopup(!showPopup);
// //               }}
// //             >
// //               <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-50 h-full w-full">
// //                 {/* Popup Box */}
// //                 <div className="bg-gray-800 rounded-xl shadow-xl p-8 text-center w-180 h-100">
// //                   <div className="text-white text-2xl flex   items-center h-1/6 w-1/2 ">
// //                     <div className="text-green-400">
// //                       <Brain />
// //                     </div>{" "}
// //                     <div className=" mx-5 font-bold">Second-Brain</div>
// //                   </div>
...
// //                     <ol className="list-decimal list-inside m-0 p-0 text-gray-100 text-lg">
// //                       <li className="text-start mt-2">
// //                         Full-stack MERN app to save and manage links and notes.
// //                       </li>
// //                       <li className="text-start mt-2">
// //                         React frontend with Express.js & MongoDB backend.
// //                       </li>
// //                     </ol>
// //                   </div>
// //                   <div className="text-green-500 text-2xl font-sans text-start mt-10">
// //                     {" "}
// //                     Fetures
// //                   </div>
// //                   <div className="flex justify-around items-center mt-5">
// //                     <div className="text-white bg-black rounded-xl text-center items-center w-40 h-10 p-2 ">
// //                       {" "}
// //                       persistent storage
// //                     </div>
// //                     <div className="text-white bg-black rounded-xl text-center  items-center w-40 h-10 p-2">
// //                       smart organization
// //                     </div>
// //                     <div className="text-white bg-black rounded-xl text-center  items-center  w-1/3 h-10 p-2">
...
// //                 <div className=" w-[98%] h-full   ">
// //                   <div className="w-full h-1/3 flex justify-around">
// //                     <div className="text-green-500 text-xl -mx-8 mt-2">
// //                       <Pen />
// //                       <span className="text-white"> Live-Sketch</span>
// //                     </div>
...
// //                     <div className="mx-12 text-gray-400">
// //                       {" "}
// //                       A Real-time Colabrative Canvas
// //                     </div>
// //                     <a
// //                       href="https://github.com/Dulesh123/Second-Brain"
// //                       className="mx-20"
...
// //                       MERN
// //                     </button>
// //                     <button className="text-gray-400 h-8 w-2/8 rounded-xl bg-black hover:bg-gray-600 text-lg hover:text-white">
// //                       WebSockets
// //                     </button>
// //                     <button className="text-gray-400 h-8 w-2/8 rounded-xl bg-black hover:bg-gray-600 text-lg hover:text-white">
// //                       PostgreSQL{" "}
...
// //                       <Brain />
// //                     </div>{" "}
// //                     <div className=" mx-5 font-bold">Live-Sketch</div>
// //                   </div>
...
// //                       </li>
// //                       <li className="text-start mt-2">
// //                         Session and user data stored in PostgreSQL.
// //                       </li>
// //                     </ol>
// //                   </div>
// //                   <div className="text-green-500 text-2xl font-sans text-start mt-10">
...
// //                 <div className=" w-[98%] h-full   ">
// //                   <div className="w-full h-1/3 flex justify-around">
// //                     <div className="text-blue-500 text-xl mx-5 mt-2">
// //                       <Solana />
// //                       <span className="text-white">Sol-care</span>
// //                     </div>
...
// //                       <Brain />
// //                     </div>{" "}
// //                     <div className=" mx-5 font-bold">Sol-Care</div>
// //                   </div>

// //                   <div className="text-white text-xl text-start ">A D-App</div>
// //                   <div className="text-white mt-5">
// //                     <ol className="list-decimal list-inside m-0 p-0 text-gray-100 text-lg">
// //                       <li className="text-start mt-2">Multi-chain wallet.</li>
// //                       <li className="text-start mt-2">
// //                         blockchain data fetching (JSON-RPC).
// //                       </li>
// //                     </ol>
// //                   </div>
// //                   <div className="text-green-500 text-2xl font-sans text-start mt-10">
...
// // function Popup() {
// //   return (
// //     <div className="bg-gray-900 w-1/3 h-1/3">
// //       <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-50 h-full w-full">
// //         {/* Popup Box */}
// //         <div className="bg-gray-700 rounded-xl shadow-xl p-8 text-center w-180 h-100"></div>
// //       </div>
// //     </div>
// //   );
// // }
...
//       {/* Foreground content */}
//       <div className="relative z-10 flex justify-center items-start px-4 sm:px-6 py-8 sm:py-12 md:py-24">
...
//             <div className="text-3xl sm:text-4xl md:text-5xl text-white font-bold">Hi, I'm Dulesh</div>
...
//             <div className="text-blue-500 text-2xl sm:text-3xl font-semibold mb-2 sm:mb-3">
//               Projects
//             </div>
...
//       <div className="w-full flex justify-center px-4 sm:px-6 pb-12 sm:pb-24">
...
//                       <Brain />
//                       <span className="text-white text-sm sm:text-base md:text-xl">Second-Brain</span>
//                     </div>
...
//                     </div>
//                     <a href="https://github.com/Dulesh123/Second-Brain" className="text-white hover:text-gray-300">
//                       <Github />
//                     </a>
//                   </div>
...
//                   <Brain  />
//                   <div className="text-white text-xl sm:text-2xl font-bold">Second-Brain</div>
//                 </div>
...
//                   <li>Full-stack MERN app to save and manage links and notes.</li>
...
//                   <div className="text-gray-300 bg-black rounded-xl px-3 py-2 text-xs sm:text-sm md:text-base">
//                     persistent storage
//                   </div>
//                   <div className="text-gray-300 bg-black rounded-xl px-3 py-2 text-xs sm:text-sm md:text-base">
//                     smart organization
...
//                       <Pen />
//                       <span className="text-white text-sm sm:text-base md:text-xl">Live-Sketch</span>
//                     </div>
//                     <div className="text-white text-xs sm:text-sm md:text-xl font-semibold">
//                       Full-stack Engineer
//                     </div>
...
//                   <Pen  />
//                   <div className="text-white text-xl sm:text-2xl font-bold">Live-Sketch</div>
//                 </div>
...
//                     <div className="flex items-center gap-2 text-blue-500">
//                       <Solana />
//                       <span className="text-white text-sm sm:text-base md:text-xl">Sol-care</span>
//                     </div>
...
//                 <div className="flex items-center gap-3 mb-4 text-green-500">
//                   <Solana />
//                   <div className="text-white text-xl sm:text-2xl font-bold">Sol-Care</div>
//                 </div>
